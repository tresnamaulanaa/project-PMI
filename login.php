...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($db, "SELECT * FROM tb_admin WHERE username = '$username' and password='$password'");
...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="pegawai.php">
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('assets/bg/memphis-colorful.png');">
