...
<div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Pegawai Dilapangan</h3>
            </div>
            <hr>
        </div>
    <div class="row my-2">
        <div class="col-md">
            ...
            <hr>
                <a href="diluar.php" class="btn btn-secondary">Batal</a>
