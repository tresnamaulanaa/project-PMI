    ...
    <div class="row my-2">
        <div class="col-md">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control w-50" id="npp" placeholder="Masukkan NPP" min="1" name="npp" autocomplete="off" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control w-50" id="tmp_lahir" placeholder="Masukkan Tempat Lahir" name="tmp_lahir" autocomplete="off" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control w-50" id="nope" placeholder="Masukkan Nomor Handphone" min="1" name="nope" autocomplete="off" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control w-50" id="pendidikan" placeholder="Masukkan Sekolah Terakhir" name="pendidikan" autocomplete="off" required>
            </div>
            <div class="mb-3">
                <label for="jabatan" class="form-label">Jabatan</label>
                <input type="text" class="form-control w-50" id="jabatan" placeholder="Masukkan Jabatan" name="jabatan" autocomplete="off" required>
            </div>
            <div class="mb-3">
                <label for="tmt" class="form-label">Tahun Mulai Tugas</label>
                <input type="date" class="form-control w-50" id="tmt" name="tmt" required>
            </div>
            <div class="mb-3">
                <label for="status_pegawai" class="form-label">Status Pegawai</label>
                <input type="text" class="form-control w-50" id="status_pegawai" placeholder="Masukkan Status Pegawai" name="status_pegawai" autocomplete="off" required>
            </div>
            <div class="mb-3">
